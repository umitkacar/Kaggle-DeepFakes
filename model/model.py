...
class Model:
    ...
    def compile(self):
        ...
        self.checkpoint_manager = tf.train.CheckpointManager(checkpoint, checkpoint_dir, max_to_keep=10000)
    ...
    def train(self, train, val=None):
        ...
        for epoch in range(self.last_epoch, epochs):
            ...
            for step in range(step_per_epoch):
                ...
                # plot the figure
                if (step + 1) % 5 == 0:
                    fname = self.config.LOG_DIR + '/epoch-' + str(epoch + 1) + '-train-' + str(1) + '.png'
    ...
    def train_one_step(self, data_batch, step, training):
        ...
        _to_plot = [image[:,:,:,0:3],image[:,:,:,3:], dmap, 
                    dmap_pred[0],dmap_pred[1],dmap_pred[2],
                    dmap_pred[3],dmap_pred[4],dmap_pred[5],
                    dmap_pred[6],dmap_pred[7]]
