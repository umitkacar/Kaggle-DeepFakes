...
DEEPFAKE_MODEL_PATH = "/home/umit/xDeepFake/log/model/ckpt-269"
...
if __name__ == "__main__":
    ...
    #cap = cv2.VideoCapture("/media/umit/wd4tb/xDeepFake/deepfake-detection-challenge/train_full_videos/dfdc_train_part_49/dwwytkheyx.mp4")
    cap = cv2.VideoCapture("/home/umit/xDataset/kaggle/input/deepfake-detection-challenge/test_videos/ahjnxtiamx.mp4")
    # OpenCV image config                
    ...
    while(cap.isOpened()):
        ...
        if ret==True:
            ...
            if xFace:
                ...
                last_score = (dmap_score + cls_score)*0.5
